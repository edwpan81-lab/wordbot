...
3. Avoid generic sentences like "The word ... is used in context."
4. Keep it under 22 words.
...
6. Prefer same-topic alternatives that name related objects, actions, or concepts, not near-equivalent meanings.
...
3. Grammatically usable in the sentence if substituted, but semantically clearly wrong.
4. Stay in the same broad category or classroom topic when possible.
5. Prefer sibling-category words over totally random words.
6. It is acceptable if they are less semantically close, as long as they are safe and not random nonsense.

Good fallback style:
- statement: question, instruction, summary
- businessman: teacher, farmer, artist
- though: because, unless, until
- jeans: socks, gloves, scarves
...
3. They are not random nonsense.
4. They would be clearly wrong in this context.
